...
class Config:
    ...
    def __init__(self):
        try:
            ...
            self.piaLoc = file.readline().split('pia_loc:')[1].strip()
        except Exception as e:
            print('Unable to grab configuration variables from .env. Exiting...')
            exit(1)
config = Config()